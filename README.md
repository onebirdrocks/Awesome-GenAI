...
- [Steel Browser](https://github.com/steel-dev/steel-browser) - Open-source browser sandbox and automation infrastructure for AI agents and apps, with an AI-native CLI and reusable skill for session-backed workflows, screenshots, PDFs, proxies, and anti-bot tooling. [![Forks](https://img.shields.io/github/forks/steel-dev/steel-browser?style=social)](https://github.com/steel-dev/steel-browser/network/members) [![Stars](https://img.shields.io/github/stars/steel-dev/steel-browser?style=social)](https://github.com/steel-dev/steel-browser/stargazers)
